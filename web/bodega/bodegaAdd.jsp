<%-- 
    Document   : bodegaAdd
    Created on : 22-04-2014, 12:17:50 PM
    Author     : alexander
--%>
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-edit"></i> Agregar Bodega
                    </li>
                </ol>
                <!-- end breadcrumb -->
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-togglebutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form action="BodegaAddServlet" method="POST" name="formAdd" id="formAdd" class="smart-form" novalidate="novalidate">
                                            <fieldset>
                                                <div class="row">
                                                    <section class="col col-6">                                                        
                                                        <c:if test="${msgErrorWareHouse == null}">                                                           
                                                            ...
                                                            <label class="input"> <i class="icon-prepend fa fa-building"></i>
                                                                <input type="text" maxlength="30" name="warehousename" placeholder="Ingrese nombre de bodega" value="<c:out value="${warehousename}" />">
                                                    ...
                                                    <section class="col col-6">                                                        
                                                        <c:if test="${msgErrorWareHouse == null}">                                                           
                                                            ...
                                                            <label class="input"> <i class="icon-prepend fa fa-square-o"></i>
                                                                <input type="text" maxlength="10" name="volume" placeholder="Ingrese metros cúbicos" value="<c:out value="${volume}" />">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var $checkoutForm = $('#formAdd').validate({
                    ...
                    messages: {
                        warehousename: {
                            required: 'Por favor ingrese nombre de bodega'
                        },
                        volume: {
                            volume: 'Por favor ingrese solo valores numéricos'
                        },
                    },
